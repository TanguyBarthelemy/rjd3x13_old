...
#' 1 - same seasonal filters for all periods (e.g.: `seasonal.filter = "Msr"`);
#' or the period length - a seasonal filer is defined for each period (e.g. for quarterly series: `seasonal.filter = c("S3X3", "Msr", "S3X3", "Msr")`).
