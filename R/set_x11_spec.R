...
#' 1 - same seasonal filters for all periods (e.g.: `seasonalma = "Msr"`);
#' or the period length - a seasonal filer is defined for each period (e.g. for quarterly series: `seasonalma = c("S3X3", "Msr", "S3X3", "Msr")`).
