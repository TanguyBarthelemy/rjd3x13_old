...
#' List of all available estimation output objects (series, parameters, diagnostics)
#'
#' Function generating a comprehensive list of available output variables generated in the estimation process
...
#'
#'@param x a character to indicate the estimation function for which the output items list will be edited.
#'
#' @examples
...
#' @return  a vector of string conataing all the available output objects (series, diagnostics, parameters)
